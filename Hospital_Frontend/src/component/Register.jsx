    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 px-6 py-12">
      <div className="max-w-screen-lg w-full flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(https://img.freepik.com/free-vector/realistic-world-blood-donor-day-vertical-poster-template-with-blood-bag_23-2149420110.jpg?t=st=1732214070~exp=1732217670~hmac=308e06fe061d3171726ad9f69f5119663e5dcfc7a561bbe5d9b8421d787510be&w=740)',
          }}
        ></div>
